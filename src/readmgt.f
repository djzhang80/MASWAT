...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      integer :: io_status
      character (len=13),intent(in) :: mgtfile
...
!!    read general management parameters
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) nmgt(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) igro(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) ncrp
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) laiday(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) bio_ms(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) phu_plt(1,1,ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
!     read (109,*) curyr_mat(ihru)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) biomix(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) cn2(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) usle_p(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) bio_min(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) filterw(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) iurban(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) urblu(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) irrsc(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) irrno(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) flowmin(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) divmax(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) flowfr(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) ddrain(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) tdrain(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) gdrain(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,*) nrot(ihru)
        deallocate(string)
        string=getstr(mgtfile,hruk,s_count)
      read (string,5000) titldum
        deallocate(string)
...
!!      read scheduled management practices
      ...
      read (string,5200) mon, day, husc, mgt_op, mgt1i,                  &
     &      mgt2i, mgt3i,   mgt4, mgt5, mgt6, mgt7, mgt8, mgt9
